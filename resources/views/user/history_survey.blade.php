                                                            ...
                                                            <table class="table table-hover datatab">
                                                              ...
                                                              <tbody>
                                                                <tr>
                                                                  ...
                                                                  <td><a href="{{ route('cetak_survey') }}" target="_blank" id="btn-f" class="btn btn-outline-success">Cetak</a></td>
                                                                </tr>
                                                                <tr>
                                                                  <th scope="row">2</th>
                                                                  <td>Contoh 2</td>
                                                                  ...
                                                                  <td class="text-success">Disetujui</td>
                                                                  <td><button id="btn-f" class="btn btn-outline-success">Cetak</button></td>
                                                                </tr>
                                                              </tbody>
                                                            </table>
                                                        </div>
