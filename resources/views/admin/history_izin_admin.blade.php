        ...
        <table class="table table-hover datatab">
          ...
          <tbody>
            ...
            <tr style="text-align: center;">
              ...
              <!-- button modal -->
              <td><button id="btn-f" type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#detail-surat-izin-{{ $data_izin->id_surat_izin }}" data-id="{{ $data_izin->v }}">Detail</button></td>
